...
fun readConfigProperty(name: String): String =
    readLocalProperty(name).ifBlank { gradleProperties.getProperty(name, "") }

android {
    namespace = "com.teodordevtech.arcadiatourism"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.teodordevtech.arcadiatourism"
        minSdk = 26
        targetSdk = 35
        versionCode = 2
        versionName = "1.1"
        ...
        buildConfigField(
            "String",
            "SUPABASE_URL",
            "\"${readConfigProperty("SUPABASE_URL")}\""
        )
        buildConfigField(
            "String",
            "SUPABASE_ANON_KEY",
